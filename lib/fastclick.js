...
FastClick.prototype.maybeSendClick = function(targetElement, event) {
	...
	// Synthesise mousedown, mouseup, and click events
	...
	event = document.createEvent('MouseEvents');
	event.initMouseEvent('mouseup', true, true, window, 1, touch.screenX, touch.screenY, touch.clientX, touch.clientY, false, false, false, false, 0, null);
	targetElement.dispatchEvent(event);
	...
	// The click event needs an extra attribute so it can be tracked
